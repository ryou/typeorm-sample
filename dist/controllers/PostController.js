...
router.get('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Post_1.default.find({ relations: ['user'] })];
            case 1:
                posts = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, Post_1.default.findOne(postId, { relations: ['user'] })
                    // TODO: ここのガードの共通化
                ];
            case 1:
                post = _a.sent();
...
router.put('/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                postId = req.params.id;
                return [4 /*yield*/, Post_1.default.findOne(postId)];
            case 1:
                post = _a.sent();
                if (post === undefined) {
                    res.status(404);
